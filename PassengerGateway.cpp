...
bool PassengerGateway::login(Passenger passenger) {
    cout << "Passenger " << passenger.getName() << " logins into the application..." << endl;
...
void PassengerGateway::showOrderHistory(Passenger passenger) {
    cout << "Retrieving order history..." << endl;
...
void PassengerGateway::placeOrder(Passenger passenger, string from, string to, string time) {
    app.addOrder(move(passenger), from, to, time);
    cout << "Passenger " << passenger.getName() << " placed order!" << endl;
    cout << "New order created!" << endl;
}

string PassengerGateway::getTime(string from, string to) {
